...
namespace ReportService1012.MQ
{
    ...
    public class RabbitMQConsumer : IDisposable
    {
        ...
        /// <param name="as_ip">MQ服务器地址</param>
        /// <param name="as_port">MQ服务器端口号</param>
        public RabbitMQConsumer(string as_consumerName, string as_id, string as_psword, IPEndPoint as_ip) : this(as_consumerName, as_id, as_psword, as_ip.Address.ToString(), as_ip.Port)
        {
